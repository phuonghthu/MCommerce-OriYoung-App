...
public class DeliveringAdapter extends RecyclerView.Adapter<DeliveringAdapter.ViewHolder>{
    ...
    public DeliveringAdapter(Context context, ArrayList<OrderHistory> orderHistory, ArrayList<CheckoutCart> productitem) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DeliveringAdapter.ViewHolder(view);
    }
